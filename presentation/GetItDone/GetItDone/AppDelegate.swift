...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func requestNotificationPermission() {
        ...
        center.requestAuthorization(options: [.alert, .sound, .badge]) { granted, error in
            if granted {
                ...
                // Perform further setup for notifications, if necessary
    ...
    func setupNotificationSettings() {
        // Setup notification categories, actions, etc.
        let center = UNUserNotificationCenter.current()
        
        // Example: Setting up a notification category with actions
        let action = UNNotificationAction(identifier: "ACTION_IDENTIFIER", title: "Action", options: [])
        let category = UNNotificationCategory(identifier: "CATEGORY_IDENTIFIER", actions: [action], intentIdentifiers: [], options: [])
        
        center.setNotificationCategories([category])
        
        // Ensure your notifications will include this category identifier where needed
    }
